  ...
  const categoryButtons = CATEGORIES.map((cat) => {
    ...
    return `<div class="builder-cat">
      ...
      <form method="POST" action="/u/${req.params.token}/upload" enctype="multipart/form-data" class="builder-upload-form">
        ...
        <input type="file" name="files" multiple accept="image/*,application/pdf" capture="environment">
  ...
  return layout(
    ...
    `<div class="card narrow">
      ...
      <form method="POST" action="/admin/properties">
        ...
        <p class="hint">This becomes the URL you program onto the property's NFC plaque: <strong>${domainDisplay}/p/[slug]</strong></p>
